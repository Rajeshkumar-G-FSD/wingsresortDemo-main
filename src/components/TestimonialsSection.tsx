...
export const TestimonialsSection: React.FC = () => {
  ...
  return (
    <section id="testimonials" className="py-16 md:py-20 bg-[#d9f1f0] px-5 md:px-12 relative overflow-hidden">
      {/* Decorative Palm Leaves */}
      <div className="absolute -left-10 bottom-0 opacity-15 pointer-events-none w-64 h-64">
        <span className="material-symbols-outlined text-[200px] text-[#004449]">forest</span>
      </div>

      <div className="max-w-[1100px] mx-auto relative z-10 flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
        {/* Quote Block */}
