...
export const HeroSection: React.FC<HeroSectionProps> = ({ onSelectService }) => {
  ...
  return (
    <div className="relative bg-[#fbf9f6] text-[#004449] overflow-hidden">
      <section
        id="hero"
      ...
      >
        ...
        {/* Legibility scrim: strong on the left where the text sits, easing off to the right.
            Stays dark regardless of the site's light theme — this is purely so the white headline
            text reads over a photo, not a page-background color choice. */}
        <div className="absolute inset-0 z-[2] pointer-events-none bg-gradient-to-r from-[#190A01]/90 via-[#190A01]/50 to-[#190A01]/10 lg:from-[#190A01]/92 lg:via-[#190A01]/45 lg:to-transparent" />
        <div className="absolute inset-0 z-[2] pointer-events-none bg-gradient-to-t from-[#190A01]/60 via-transparent to-transparent" />
      ...
      <section id="services" className="relative z-20 pb-12 pt-2 px-5 md:px-12 max-w-[1440px] mx-auto">
        <div className="relative">
            ...
            >
              {SERVICES.map((service, i) => (
                ...
                >
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#190A01]/92 via-[#190A01]/30 to-[#190A01]/5" />
              ...
              {SERVICES.map((service, i) => (
                <span
                  ...
                  className={`h-1.5 rounded-full transition-all duration-300 ${
                    i === mobileActiveIndex ? 'w-6 bg-[#F0801A]' : 'w-1.5 bg-[#e4e2df]'
                  }`}
                />
              ))}
            </div>
          ...
          <div ref={servicesRef} className="services-reveal hidden lg:grid lg:grid-cols-4 gap-4 lg:pr-60 xl:pr-72">
            ...
            {SERVICES.map((service) => (
              <div
                key={service.id}
                onClick={() => onSelectService(service.id)}
                className="bg-white rounded-xl p-6 min-h-[258px] flex flex-col items-center text-center border border-[#e4e2df] shadow-sm hover:shadow-md transition-all group cursor-pointer"
              >
          ...
          <div className="hidden lg:block absolute -top-24 right-0 w-[280px] xl:w-[330px] aspect-[1/1.5] z-30 pointer-events-none">
            ...
            <div className="relative w-full h-full p-2.5 rounded-t-[180px] rounded-b-3xl bg-white shadow-2xl border-2 border-[#F0801A]">
